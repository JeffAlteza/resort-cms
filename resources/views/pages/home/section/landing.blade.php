<section style="background-image: url('{{ asset('storage/'.$homeData['image']) }}');" class="h-screen w-screen bg-center bg-no-repeat bg-cover bg-gray-700 flex items-center justify-center mx-auto">

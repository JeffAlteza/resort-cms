...
@foreach ($featureDatas as $index => $featureData)
    <div
        ...
        <!-- Image Div -->
        <div
            class="md:w-2/3 p-8 lg:p-6 flex items-center justify-center transform hover:scale-105 transition-transform duration-500">
        ...
        <div style="color: #1f1f1f" class="md:w-1/3 flex items-center justify-center">
            <div data-aos="fade-up" data-aos-duration="1000" class="px-12 pt-0 pb-5 md:py-8 md:px-0 lg:p-10 lg:px-6">
                ...
                <div class="flex justify-center md:justify-start lg:justify-start">
                    ...
                    <a href="#next"
                        class="inline-flex justify-center items-center mt-5 py-1 px-7 text-lg font-semibold text-center text-white rounded-full bg-green-600 border border-green-600 hover:bg-green-700 focus:ring-4 focus:ring-gray-400 shadow">
                        View More
                    </a>
                </div>
            </div>

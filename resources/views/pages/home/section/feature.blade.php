<div class="min-h-5/6 flex items-center justify-center">
    <div class="text-center px-36 pt-10">
        ...
        <div class="px-2 lg:px-40">
            <p data-aos="fade-up" data-aos-duration="1100" class="text-lg md:text-lg lg:text-xl text-gray-600">
...
@foreach ($featureDatas as $index => $featureData)
    <div class="min-h-4/5 lg:px-48 flex flex-col md:flex-row {{ $index % 2 === 0 ? '' : 'md:flex-row-reverse' }}">
        <!-- Image Div -->
        <div
            class="lg:w-3/5 md:w-2/3 p-8 md:px-2 lg:p-6 flex items-center justify-center transform hover:scale-105 transition-transform duration-500">
        ...
        <div style="color: #1f1f1f" class="lg:w-2/5 md:w-1/3 flex items-center justify-center">
            <div data-aos="fade-up" data-aos-duration="1000" class="px-12 pt-0 pb-5 md:py-8 md:px-2 lg:p-10 lg:px-6">
                <!-- Content in the center of the white div -->
                <div class="flex justify-center md:justify-start lg:justify-start">
                    <h1 class="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-5">
                ...
                <div class="flex justify-center md:justify-start lg:justify-start">
                    ...
                    <a data-aos="fade-up" data-aos-duration="1000" href="#next"
                        class="inline-flex justify-center items-center mt-5 py-2 px-4 text-md  text-center text-green-600 rounded-full bg-white border border-green-600 hover:bg-green-600 hover:text-white focus:ring-4 focus:ring-gray-400 ">
                        View More
                    </a>
                </div>
            </div>

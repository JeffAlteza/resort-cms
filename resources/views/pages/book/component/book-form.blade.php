    ...
    <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-11 md:px-6">
        ...
        <div class="flex flex-wrap ">
            ...
            <div class="w-full px-4 lg:w-1/2">
                <form action="{{ route('book-mail') }}" method="post" class="p-6 bg-white  rounded-lg">
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="relative mb-3" data-te-datepicker-init data-te-inline="true" data-te-input-wrapper-init data-te-format="yyyy-mm-dd">

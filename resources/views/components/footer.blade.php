...
<footer class="relative pt-8 pb-0">
    ...
    <div class="flex flex-wrap items-center md:justify-between justify-center">
      <div class="w-full md:w-4/12 px-4 mx-auto text-center">
        <div class="text-sm text-white font-semibold py-1">
          Copyright © <span id="get-current-year">{{ date('Y') }}</span><a href="/" class="text-white hover:text-gray-100" target="_blank"> {{ env('APP_NAME') }}
          {{-- <a href="https://www.creative-tim.com?ref=njs-profile" class="text-white hover:text-blueGray-800">Creative Tim</a>. --}}
        </div>
      </div>
    </div>
  </div>

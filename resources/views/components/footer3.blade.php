            ...
            <div class="flex flex-wrap pt-6 pb-0 -mx-3">
                <div class="w-full px-4 mb-11 md:w-1/2 lg:w-3/12 lg:mb-0">
                    <a href="#" class="inline-block mb-4 text-xl font-bold text-gray-200 ">About
                        Company</a>
                    <p class="text-base font-normal leading-6 text-white lg:w-64 ">
                ...
                <div class="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-3/12">
                    ...
                    <p class="flex items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="w-4 h-4 mr-1 text-white  bi bi-geo-alt " viewBox="0 0 16 16">
                            <path
                                d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A31.493 31.493 0 0 1 8 14.58a31.481 31.481 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94zM8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10z">
                            </path>
                            <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path>
                        </svg>
                        <span class="text-white ">{{$contact['Location']}}</span>
                    </p>
                    <p class="flex items-center mb-4 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="w-4 h-4 mr-2 text-white  bi bi-envelope" viewBox="0 0 16 16">
                            <path
                    ...
                    <p class="flex items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="w-4 h-4 mr-2 text-white  bi bi-telephone" viewBox="0 0 16 16">
                            <path
                        ...
                        <span class="text-white ">{{$contact['Cellphone']}}</span>
                    </p>
                </div>
                ...
                <div class="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-3/12">
                    ...
                    <a href="{{$contact['Facebook']}}" class="flex items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor"
                            class="w-4 h-4 mr-2 text-white bi bi-facebook" viewBox="0 0 16 16">
                            <path
                    ...
                    <a href="{{$contact['Instagram']}}" class="flex items-center mb-4">
                        ...
                        <span class="text-white hover:text-white">Instagram</span>
                    </a>
                </div>
            </div>
        </div>
